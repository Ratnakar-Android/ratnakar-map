...
import com.bus.map.demo.adapters.ChatroomRecyclerAdapter;
import com.bus.map.demo.models.Chatroom;
...
import com.bus.map.demo.service.LocationService;
...
import static com.bus.map.demo.Constants.ERROR_DIALOG_REQUEST;
import static com.bus.map.demo.Constants.PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION;
import static com.bus.map.demo.Constants.PERMISSIONS_REQUEST_ENABLE_GPS;
        ...
        ChatroomRecyclerAdapter.ChatroomRecyclerClickListener
{
    ...
    //step - 1 Get the Uer detail from firebase db
    ...
    //step - 2 Get the Uer last location
    ...
    //step - 3 Save the last location to database
    ...
    // Is Gps is enabled or not for particular application
    ...
    // This method checks is user is able to use Google service or not
